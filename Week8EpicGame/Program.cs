//string[] heroes = {"John Wick", "Raigo", "Mario", "Niko Bellic", "Lara Croft" };
//string[] pahalased = {"King Kong", "Bowser", "Gollum", "Joker" };
...
string[] weapon = { "Mõõk", "Nuga", "AK47", "tellis", "Rusikas", "plätu" };
...
Console.WriteLine($"Today {villain} ({villainHP}) HP tries to take over the world using {villainWeapon}.");
